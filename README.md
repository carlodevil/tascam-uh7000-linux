...
that USB Audio 2.0 configuration on hotplug so Linux can bind it with the
standard `snd_usb_audio` driver.
...
```sh
sudo dpkg -i dist/tascam-uh7000-linux_0.1.0-1_all.deb
```
